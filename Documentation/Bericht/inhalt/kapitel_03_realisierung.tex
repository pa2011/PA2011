...
\begin{figure}[H]
\centering 
\includegraphics[width=1.0\linewidth]{src/Sequenzdiagramm.pdf}
\caption{Sequenzdiagramm des Fahrsimulators} % Titel der Grafik
\label{sequenzdiagramm_fahrsimulator} % Labelname
\end{figure}
