...
\newglossaryentry{vsync}{
	name={Vsync},
	description={Vertical Sync - bedeutet, dass mit dem Neuberechnen eines Bildes gewartet wird, bis der gesamte Bildschirminhalt gezeichnet wurde. Dadurch wird die Verzerrung des Bildes durch schnelle Bewegungen verhindert}
}
...
\newglossaryentry{mplayer}{
	name={MPlayer},
	description={Mächtiger Opensource-Mediaplayer. Offizielle Website: http://www.mplayerhq.hu}
}
\newglossaryentry{mipmap}{
	name={Mipmap},plural={Mipmaps},
	description={Gefilterte und verkleinerte Version einer Textur, um dem Aliasing-Effekt entgegenzuwirken}
}
